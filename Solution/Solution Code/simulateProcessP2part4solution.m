...
function [tData,yData] = simulateProcessP2part4solution
    ...
    %---------------------------------------------------------------------%
    %PCA does detect the fault. 
    %The number of threshold crossings is higher than we
    %would expect for normally operation. 
    %However, the T^2 plot looks much closer to the one we saw for a
    %normally operating process than for the one we saw for the fault in
    %part 3.
